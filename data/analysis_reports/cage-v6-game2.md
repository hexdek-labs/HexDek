# Game `cage-v6-game2` Forensic Analysis
...
- **Turns played**: 16
- **Events captured**: 2050
- **Findings**: 2 CRITICAL / 6 WARN / 8 INFO

### Seats

| Seat | Commander | Archetype | Final life | Status |
| ---- | --------- | --------- | ---------- | ------ |
| 0 | Ashling, Rekindled // Ashling, Rimebound | recursion_graveyard | -4 | LOST (combat damage) |
| 1 | Coram, the Undertaker | recursion_graveyard | 26 | **WINNER** |
...
6. **[Storm deck never fires]** Seat 2 (Oloro, Ageless Ascetic) has storm payoffs ['Aetherflux Reservoir'] but never cast them (game had 39 total casts)
...
1. **[Commander never cast]** Seat 2 (Oloro, Ageless Ascetic) never cast their commander across 16 turns
...
2. **[Commander never cast]** Seat 3 (Varina, Lich Queen) never cast their commander across 16 turns
...
6. **[Mana floated]** Seat 1 floated ≥3 mana at phase boundary for 8 turns

   - Seats: `1`, Turns: `6, 8, 10-14, 16`
...
7. **[Mana floated]** Seat 2 floated ≥3 mana at phase boundary for 10 turns
...
8. **[Mana floated]** Seat 3 floated ≥3 mana at phase boundary for 5 turns
...
- Final life: **-4**, hand=1, library=77, graveyard=3
- Commander casts: Ashling, Rekindled // Ashling, Rimebound×3

### Seat 1: Coram, the Undertaker

- Final life: **26**, hand=0, library=66, graveyard=18
- Battlefield (16): Chainer, Nightmare Adept, Coram, the Undertaker, Corpse Connoisseur, Forest, Forest, Forest, Moldgraf Monstrosity, Mountain, Perpetual Timepiece, Purple Worm, Riveteers Overlook, Swamp, Swamp, Talisman of Impulse, Timeless Witness, Treasure Vault
