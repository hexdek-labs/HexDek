...
_Generated: 2026-04-16T16:33:09-07:00_
...
- game=0 cat=event_count — kind="damage_wears_off" go=3 py=17
- game=0 cat=event_count — kind="destroy" go=7 py=11
...
- game=0 cat=event_missing_py — kind="modification_effect" go=2 py=0
...
- game=0 cat=event_count — kind="pool_drain" go=17 py=24
...
- game=0 cat=event_count — kind="state" go=41 py=111
- game=0 cat=event_count — kind="turn_start" go=42 py=56
- game=0 cat=event_missing_go — kind="tutor" go=0 py=3
- game=0 cat=event_missing_py — kind="unknown_effect" go=33 py=0
- game=0 cat=event_count — kind="untap_done" go=191 py=260
