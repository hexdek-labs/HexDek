...
| 2026-05-19 | Loki r41 | **AttachmentConsistency (14→23)** — aura/equipment attached state diverges from controller's battlefield | Low | Likely stale `AttachedTo` after cross-seat control change. See `docs/loki-r41-report.md` |
...
| 2026-05-19 | Loki r41 follow-up | **Token / spell-copy zone conservation drift** — 824 "extra real cards appeared" ZoneConservation hits in game 181 (Krark, the Thumbless deck). Copy-spell + token reanimator interactions add cards to the census without backing storage | Med | Top correlated card: Nevinyrral, Urborg Tyrant. Surfaced once the Cerulean Sphinx cluster cleared. Repro: `--games 182 --seed 41` |
